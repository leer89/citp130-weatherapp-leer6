package com.example.randylee.weatherapp.Model;

import java.util.List;

/**
 * Create private instances
 * Check json for variable names
 * Set this variables from open weather
 * Mutator methods
 * Shortcut - alt+insert to automatically create getters/setters, constructor, methods
